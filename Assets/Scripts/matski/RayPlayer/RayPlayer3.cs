...
public class RayPlayer3 : MonoBehaviour
{
    #region//インスペクターで設定する
    ...
    public static RayPlayer3 instance;
    ...
    void Update()
    {
        ...
        //UnityEngine.Debug.DrawRay(this.transform.position, Vector3.down * 10.5f, Color.blue);
        ...
        {
            if (pagemove.GetComponent<ShaftManager3>().pageMove1 == false && pagemove.GetComponent<ShaftManager3>().pageMove2 == false && pagemove.GetComponent<ShaftManager3>().pageMove3 == false)
            {
